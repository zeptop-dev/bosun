...
export interface Inbound {
  ...
  up?: number; down?: number; no_sniff?: boolean
  fallbacks?: Fallback[]
...
export interface Settings { public_host: string; node_name: string; acme_email: string; cloudflare_token: string; has_cloudflare_token?: boolean; has_telegram_token?: boolean; decoy_allow_private?: boolean; decoy_insecure?: boolean; panel_domain: string; panel_acme: string; decoy_enabled: boolean; decoy_domain: string; decoy_upstream: string; decoy_acme: string; user_speed_limit_mbps: number; mita_quotas?: boolean; panel_allow_cidrs: string[]; extra_links: string; telegram_token: string; telegram_chat_id: number; telegram_notify: boolean }
