...
export const theme = createTheme({
  ...
  components: {
    ...
    MultiSelect: { styles: { label: { fontSize: rem(12), letterSpacing: '0.04em', textTransform: 'uppercase', opacity: 0.7 } } },
    DateInput: { styles: { label: { fontSize: rem(12), letterSpacing: '0.04em', textTransform: 'uppercase', opacity: 0.7 } } },
    JsonInput: { styles: { label: { fontSize: rem(12), letterSpacing: '0.04em', textTransform: 'uppercase', opacity: 0.7 } } },
